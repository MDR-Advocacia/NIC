...
const LawyerDetailModal = ({ isOpen, onClose, lawyer }) => {
    ...
    const liveloDealCount = lawyer.livelo_deals || 0;
    const ourocapDealCount = lawyer.ourocap_deals || 0;
        ...
        <div className={styles.modalOverlay} onClick={handleOverlayClick}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                ...
                <div className={styles.metricsGrid}>
                    ...
                    <DetailKpiCard
                        title="Livelo"
                        value={liveloDealCount}
                        subtext="Acordos com Livelo"
                    />
                    <DetailKpiCard
                        title="OuroCap"
                        value={ourocapDealCount}
                        subtext="Acordos com OuroCap"
                    />
                </div>
