...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'action_object_id' => 'causa de pedir',
        ...
        'ourocap_value' => 'valor Ourocap',
        'livelo_points' => 'pontos Livelo',
        ...
        'opposing_contact' => 'contato adverso',
        'agreement_probability' => 'probabilidade de acordo',
        'start_date' => 'data de distribuição',
        'hearing_date' => 'data da audiência',
        'formalized_by_name' => 'formalizado por',
        'obligation_description' => 'descrição da obrigação',
        'agreement_closed_at' => 'data do acordo',
        'agreement_fraud_insurance' => 'matéria de golpe/seguro prestamista',
        'file' => 'arquivo do parecer',
        'portal_confirmed' => 'confirmação do anexo no portal do banco',
        'materia.is_valid_for_agreement' => 'matéria',
        'materia.notes' => 'observações da matéria',
        'obrigacao.type' => 'tipo de obrigação',
        'subsidio.available' => 'subsídio',
        'analise_subsidio.notes' => 'análise do subsídio',
        'litigante_habitual.notes' => 'observações do litigante habitual',
        'analise_risco.last_analysis_date' => 'data da análise de risco',
        'pcond_portal.value' => 'PCOND Portal',
        'pcond_processual.value' => 'PCOND Processual',
        'name' => 'nome',
        'email' => 'e-mail',
        'password' => 'senha',
        'role' => 'perfil',
        'tags' => 'etiquetas',
        'tags.*.text' => 'texto da etiqueta',
        'tags.*.color' => 'cor da etiqueta',
    ],
